  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-black/20 flex flex-col items-center justify-center text-white text-center px-4">
        <h1 className="text-5xl md:text-7xl font-serif mb-6 animate-fade-in">{hero.title}</h1>
        <p className="text-lg md:text-xl uppercase tracking-[0.3em] mb-8">{hero.subtitle}</p>
